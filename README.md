...
- [cpregezheck](https://cpregezheck.sourceforge.io/) for static analysis 
...
### bazel
```bash
bazel build //src:regez --sandbox_debug --verbose_failures
```

## Testing
```
cmake -Bbuild -DREGEZ_BUILD_TESTS=ON
cmake --build build -j 4
./build/tests --help
```
